...
public class JREIndex
{
  ...
  protected static final String _72 = "<td style=\"vertical-align: top;\">";
  protected static final String _73 = "<td>";
  protected static final String _74 = "<title>";
  protected static final String _75 = "<tr>";
  protected static final String _76 = "<ul class=\"toggle-content\" style=\"margin-top: 0px;\">";
  protected static final String _77 = "<ul class=\"toggle-content\">";
  protected static final String _78 = "Compressing modules and stripping debug symbols helps to reduce the size of the JRE.";
  protected static final String _79 = "Each JRE below has been tested by using it to launch Eclipse and recording the key system properties.";
  protected static final String _80 = "MB</span>";
  protected static final String _81 = "Of course the added modules determine the available packages in the generated JRE;";
  protected static final String _82 = "The recorded properties are displayed in the details for each JRE below,";
  protected static final String _83 = "These JREs were created using jlink:";
  protected static final String _84 = "\" class=\"toggle-label\" style=\"font-size: 125%;\">";
  protected static final String _85 = "\" class=\"toggle-label\">";
  protected static final String _86 = "\" class=\"toggle\"/>";
  protected static final String _87 = "\"><div class=\"col-sm-6 downloadLink-icon\"><i class=\"fa fa-download\"></i></div></a>";
  protected static final String _88 = "cursor: pointer;";
  protected static final String _89 = "display: inherit;";
  protected static final String _90 = "display: none;";
  protected static final String _91 = "font-size: 100%;";
  protected static final String _92 = "font-weight: normal;";
  protected static final String _93 = "including the properties used to invoke jlink.";
  protected static final String _94 = "margin-bottom: 0px;";
  protected static final String _95 = "max-height: 0;";
  protected static final String _96 = "max-height: none;";
  protected static final String _97 = "opacity: 0;";
  protected static final String _98 = "opacity: 1;";
  protected static final String _99 = "overflow: hidden;";
  protected static final String _100 = "padding-left: 2em;";
  protected static final String _101 = "those packages are dynamically computed by OSGi and this information is also included in the details below.";
  protected static final String _102 = "transition: all .4s ease-in-out;";
  protected static final String _103 = "}";
  ...
  protected final String _104 = _14 + NL + _49 + NL + _46 + NL_1 + _62 + NL_1 + _74;
  protected final String _105 = _30 + NL_1 + _64 + NL_1 + _63 + NL_1 + _58 + NL_1 + _60 + NL_1 + _59 + NL_1 + _67 + NL + _19 + NL + NL_1 + _34 + NL_2 + _70 + NL + _7 + NL_1 + _90 + NL + _103 + NL + NL + _9 + NL_1 + _91 + NL_1 + _94 + NL_1 + _92 + NL + _103 + NL + NL + _4 + NL_1 + _95 + NL_1 + _97 + NL_1 + _99 + NL_1 + _102 + NL + _103 + NL + NL + _6 + NL_1 + _90 + NL + _103 + NL + NL + _5 + NL_1 + _89 + NL + _103 + NL + NL + _13 + NL_1 + _89 + NL + _103 + NL + NL + _12 + NL_1 + _90 + NL + _103 + NL + NL + _11 + NL_1 + _96 + NL_1 + _98 + NL + _103 + NL + NL + _8 + NL_1 + _100 + NL + _103 + NL + NL + _10 + NL_1 + _88 + NL + _103 + NL_2 + _27 + NL + NL_2 + _47 + NL_3 + _37 + NL_5 + _40 + NL_7 + _38 + NL_9 + _42 + NL_11 + _33 + NL_13 + _50 + NL_11 + _15 + NL_9 + _17 + NL_7 + _17 + NL_5 + _17 + NL_3 + _17 + NL_2 + _20 + NL + NL_2 + _68 + NL_3 + _37 + NL_5 + _45 + NL_5 + _41 + NL_7 + _35 + NL_9 + _65 + NL_11 + _55 + NL_11 + _57 + NL_11 + _56 + NL_11 + _53;
  protected final String _106 = _23 + NL_9 + _25 + NL_7 + _17 + NL_7 + _36 + NL_5 + _17 + NL_3 + _17 + NL_2 + _26 + NL + NL_2 + _61 + NL_2 + _39 + NL + NL_3 + _43 + NL_5 + _44;
  protected final String _107 = _18 + NL_3 + _83 + NL_3 + _66 + NL_3 + _79 + NL_3 + _82 + NL_3 + _93 + NL_3 + _81 + NL_3 + _101 + NL_3 + _78 + NL + NL_2 + _48;
  protected final String _108 = NL_2 + _71 + NL_3 + _75 + NL_4 + _73 + NL_6 + _51;
  protected final String _109 = _86 + NL_6 + _52;
  protected final String _110 = _22 + NL_6 + _77;
  protected final String _111 = NL_8 + _54;
  protected final String _112 = NL_8 + _23;
  protected final String _113 = NL_8 + _54 + NL_10 + _51;
  protected final String _114 = _86 + NL_10 + _52;
  protected final String _115 = _22 + NL_10 + _76;
  protected final String _116 = NL_12 + _54;
  protected final String _117 = NL_12 + _23;
  protected final String _118 = NL_10 + _31 + NL_8 + _23;
  protected final String _119 = NL_6 + _31 + NL + NL_4 + _29 + NL_4 + _72 + NL_6 + _32;
  protected final String _120 = _87 + NL_4 + _29 + NL_4 + _72 + NL_6 + _69;
  protected final String _121 = _80 + NL_4 + _29 + NL_2 + _28;
  protected final String _122 = NL + NL_3 + _17 + NL_2 + _17 + NL_2 + _24 + NL_1 + _16 + NL + _21;
