...
public class UpdateSiteTable
{
  ...
  protected final String TEXT_5 = "\"/>" + NL + "  <script src=\"https://ajax.googleapis.com/ajax/libs/jquery/3.2.1/jquery.min.js\"></script>" + NL + "</head>" + NL + "" + NL + "  <body id=\"body_solstice\">" + NL + "    <style>" + NL + "      table, th, td {" + NL + "        border: 1px solid black;" + NL + "        border-collapse: collapse;" + NL + "        padding: 0ex 1ex;" + NL + "      }" + NL + "" + NL + "      th {" + NL + "        padding: 0.5ex 1ex;" + NL + "        position: sticky;" + NL + "        top: 0;" + NL + "        z-index: 1;" + NL + "        background-color: Snow; " + NL + "      }" + NL + "" + NL + "      tr:nth-child(odd) {" + NL + "        background-color: OldLace;" + NL + "      }" + NL + "" + NL + "      th:after, th:before {" + NL + "        content: '';" + NL + "        position: absolute;" + NL + "        left: 0;" + NL + "        width: 100%;" + NL + "      }" + NL + "" + NL + "      th:before {" + NL + "        top: -1px;" + NL + "        border-top: 1px solid black;" + NL + "      }" + NL + "" + NL + "      th:after {" + NL + "        bottom: -1px;" + NL + "        border-bottom: 1px solid black;" + NL + "      }" + NL + "" + NL + "      .long-segment {" + NL + "        font-size: 85%;" + NL + "      }" + NL + "" + NL + "      .qualifier {" + NL + "        font-size: 75%;" + NL + "      }" + NL + "" + NL + "      sup {" + NL + "        font-size: 75%;" + NL + "        color: SeaGreen;" + NL + "      }" + NL + "" + NL + "      .bsn-prefix {" + NL + "        font-size: 85%;" + NL + "      }" + NL + "    </style>" + NL + "    <script>" + NL + "    </script>" + NL + "" + NL + "    <header role=\"banner\" id=\"header-wrapper\">" + NL + "      <div class=\"container\">" + NL + "        <div class=\"row\" id=\"header-row\">" + NL + "          <div class=\"hidden-xs col-sm-8 col-md-6 col-lg-5\" id=\"header-left\">" + NL + "            <div class=\"wrapper-logo-default\">" + NL + "              <a href=\"";
